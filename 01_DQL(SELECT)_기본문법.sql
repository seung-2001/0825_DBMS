 ...
 * 
 * - ResultSet : 죄회된 행들의 집합 // SELECT문을 통해 조회된 데이터 결과물을 의미함
 */
...
-- 명렁어, 키워드, 테이블명, 컬럼명은 대/소문자를 가리지 않음
...
-- 2. JOB테이블에서 직급명암 조회되게 SELECT문을 작성해보세요.
...
-- EMPLOYEE테이블로부터 사원들의 사원명, 급여조회 --> 급여가 300만원 이상인 사원들만
...
-- EMPLOYEE테이블에서 부서코드가 'D9' 면서 500만원 이하인 사원들의
-- 사원명, 부서코드, 급여조회
...
/*
 * < IN >
 * 비교대상 컬럼값에 내가 제시한 몰록들 중에 일치하는 값이 있는지
 */
