 ...
 * 
 * => 해당 테이블에 모든 컬럼에 추가하고자 하는 값을 직접 입력해서 한 행을 INSERT할 사용
 ...
 * 
 * 주의할 점 ) NOT NULL이 달려있는 컬럼은 반드시 테이블 명 뒤에 컬럼명을 적어야 함
 * 예외 사항 ) NOT NULL제약조건이 달려있는데 기본값이 있는 경우 DEFAULT VALUE가 들어감
 */
INSERT
  INTO 
       EMPLOYEE
...
-- EMPLOYE 테이블에 존재하는 모든 사원명과, 부서명을 새로만든 EMP_01에 INSERT
